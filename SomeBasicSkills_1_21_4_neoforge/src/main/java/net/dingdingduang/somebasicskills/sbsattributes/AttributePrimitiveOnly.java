...
public class AttributePrimitiveOnly {
    ...
    private ResourceLocation AttrUUID;
    private int op;
    ...
    public AttributePrimitiveOnly(double amount, int timeTicks, int operation, ResourceLocation attrUUID, String attrName, String skillID) {
        this.Amount = amount;
    ...
    public ResourceLocation getAttrUUID() { return this.AttrUUID; }
    public void setAttrUUID(ResourceLocation attrUUID) { this.AttrUUID = attrUUID; }
