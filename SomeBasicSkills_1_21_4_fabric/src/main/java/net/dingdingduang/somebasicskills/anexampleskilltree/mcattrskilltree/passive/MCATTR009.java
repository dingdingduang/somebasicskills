...
public class MCATTR009 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_LUCK_0_9);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_LUCK_0_9)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_LUCK_0_9);
        ...
        PermAttributesDistributor.applyPermLuckToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_LUCK_0_9, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_LUCK_0_9);
        tempSkillData.setTranslatableTooltipGetter(MCATTR009::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR009::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR009::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR009::passiveAction);
    }
}
