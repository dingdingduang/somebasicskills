...
public class EXMCATTR007 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_JUMP_STRENGTH_MULTIPLIER_0_7);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_JUMP_STRENGTH_MULTIPLIER_0_7)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_JUMP_STRENGTH_MULTIPLIER_0_7);
        ...
        //TODO:
        PermAttributesDistributor.applyPermJumpStrengthToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_JUMP_STRENGTH_MULTIPLIER_0_7, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_JUMP_STRENGTH_MULTIPLIER_0_7);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR007::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR007::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR007::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR007::passiveAction);
    }
}
