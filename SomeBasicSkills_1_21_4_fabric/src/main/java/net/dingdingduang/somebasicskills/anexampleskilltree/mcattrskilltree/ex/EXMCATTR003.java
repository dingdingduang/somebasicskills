...
public class EXMCATTR003 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_ARMOR_MULTIPLIER_0_3);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_ARMOR_MULTIPLIER_0_3)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_ARMOR_MULTIPLIER_0_3);
        ...
        PermAttributesDistributor.applyPermArmorToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_ARMOR_MULTIPLIER_0_3, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_ARMOR_MULTIPLIER_0_3);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR003::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR003::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR003::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR003::passiveAction);
    }
}
