...
public class EXMCATTR008 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_MINING_EFFICIENCY_MULTIPLIER_0_8);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_MINING_EFFICIENCY_MULTIPLIER_0_8)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_MINING_EFFICIENCY_MULTIPLIER_0_8);
        ...
        PermAttributesDistributor.applyPermMiningEfficiencyToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_MINING_EFFICIENCY_MULTIPLIER_0_8, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_MINING_EFFICIENCY_MULTIPLIER_0_8);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR008::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR008::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR008::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR008::passiveAction);
    }
}
