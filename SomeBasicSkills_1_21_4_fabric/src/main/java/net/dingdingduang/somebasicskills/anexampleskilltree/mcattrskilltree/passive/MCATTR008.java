...
public class MCATTR008 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MINING_EFFICIENCY_0_8);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_MINING_EFFICIENCY_0_8)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_MINING_EFFICIENCY_0_8);
        ...
        PermAttributesDistributor.applyPermMiningEfficiencyToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_MINING_EFFICIENCY_0_8, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MINING_EFFICIENCY_0_8);
        tempSkillData.setTranslatableTooltipGetter(MCATTR008::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR008::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR008::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR008::passiveAction);
    }
}
