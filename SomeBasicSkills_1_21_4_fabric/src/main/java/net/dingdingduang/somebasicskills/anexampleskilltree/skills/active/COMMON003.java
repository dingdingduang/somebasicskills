package net.dingdingduang.somebasicskills.anexampleskilltree.skills.active;
                ...
                (entity1) -> {
                    ...
                    if (!isEntityChannellingInterrupted(entity1)) {
                        ...
                        if (entity1 instanceof ServerPlayerEntity sp1) {
                            ...
                            if (playerSkillLVL > 0) {
                                applyEffectToLivingEntity(sp1, new StatusEffectInstance(StatusEffects.JUMP_BOOST, (int) Math.round(duration * 20), playerSkillLVL - 1, false, false));
                            }
                        }
                        else {
                            duration = skill1.getDuration().get(playerSkillLVL);
                            applyEffectToLivingEntity(entity1, new StatusEffectInstance(StatusEffects.JUMP_BOOST, (int) Math.round(duration * 20), 3, false, false));
                        }
