...
public class MCATTR005 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_KNOCKBACK_RESISTANCE_0_5);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_KNOCKBACK_RESISTANCE_0_5)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_KNOCKBACK_RESISTANCE_0_5);
        ...
        PermAttributesDistributor.applyPermKnockbackResistToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_KNOCKBACK_RESISTANCE_0_5, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_KNOCKBACK_RESISTANCE_0_5);
        tempSkillData.setTranslatableTooltipGetter(MCATTR005::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR005::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR005::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR005::passiveAction);
    }
}
