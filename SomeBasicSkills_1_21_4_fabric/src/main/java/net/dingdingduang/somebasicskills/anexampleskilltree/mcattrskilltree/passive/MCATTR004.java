...
public class MCATTR004 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_TOUGHNESS_0_4);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_ARMOR_TOUGHNESS_0_4)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_TOUGHNESS_0_4);
        ...
        PermAttributesDistributor.applyPermArmorToughnessToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_ARMOR_TOUGHNESS_0_4, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_TOUGHNESS_0_4);
        tempSkillData.setTranslatableTooltipGetter(MCATTR004::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR004::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR004::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR004::passiveAction);
    }
}
