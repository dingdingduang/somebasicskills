...
public class EXMCATTR005 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_KNOCKBACK_RESISTANCE_MULTIPLIER_0_5);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_KNOCKBACK_RESISTANCE_MULTIPLIER_0_5)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_KNOCKBACK_RESISTANCE_MULTIPLIER_0_5);
        ...
        PermAttributesDistributor.applyPermKnockbackResistToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_KNOCKBACK_RESISTANCE_MULTIPLIER_0_5, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_KNOCKBACK_RESISTANCE_MULTIPLIER_0_5);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR005::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR005::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR005::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR005::passiveAction);
    }
}
