...
public class MCATTR001 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_KNOCKBACK_0_1);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_ATTACK_KNOCKBACK_0_1)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_KNOCKBACK_0_1);
        ...
        PermAttributesDistributor.applyPermAttackKnockbackToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_ATTACK_KNOCKBACK_0_1, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_KNOCKBACK_0_1);
        tempSkillData.setTranslatableTooltipGetter(MCATTR001::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR001::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR001::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR001::passiveAction);
    }
}
