...
public class MCATTR002 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MOVEMENT_SPEED_0_2);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_MOVEMENT_SPEED_0_2)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_MOVEMENT_SPEED_0_2);
        ...
        PermAttributesDistributor.applyPermMovementSpeedToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_MOVEMENT_SPEED_0_2, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MOVEMENT_SPEED_0_2);
        tempSkillData.setTranslatableTooltipGetter(MCATTR002::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR002::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR002::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR002::passiveAction);
    }
}
