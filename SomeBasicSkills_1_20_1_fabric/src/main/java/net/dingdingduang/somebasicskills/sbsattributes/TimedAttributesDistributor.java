...
//    }
    ...
    public static EntityAttributeModifier.Operation ConvertIntOp2AttrOp(int operator) {
        ...
        switch (operator) {
            case 0:
                op = EntityAttributeModifier.Operation.ADDITION;
                break;
            case 1:
                op = EntityAttributeModifier.Operation.MULTIPLY_BASE;
                break;
            case 2:
                op = EntityAttributeModifier.Operation.MULTIPLY_TOTAL;
                break;
            default:
                op = EntityAttributeModifier.Operation.ADDITION;
                break;
    ...
    public static void applyTimedAttrToEntity(LivingEntity entity, UUID attrUUID, String attrName, EntityAttribute attrType, int totalTimeTicks, double amount, EntityAttributeModifier.Operation op, boolean allowDuplicate, String SkillID, MethodAction action, MethodAction finalAction) {
