...
public class MCATTR006 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MAX_HEALTH_0_6);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_MAX_HEALTH_0_6)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_MAX_HEALTH_0_6);
        ...
        PermAttributesDistributor.applyPermMaxHealthToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_MAX_HEALTH_0_6, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_MAX_HEALTH_0_6);
        tempSkillData.setTranslatableTooltipGetter(MCATTR006::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR006::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR006::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR006::passiveAction);
    }
}
