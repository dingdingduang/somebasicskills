...
public class MCATTR003 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_0_3);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_ARMOR_0_3)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_0_3);
        ...
        PermAttributesDistributor.applyPermArmorToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_ARMOR_0_3, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ARMOR_0_3);
        tempSkillData.setTranslatableTooltipGetter(MCATTR003::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR003::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR003::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR003::passiveAction);
    }
}
