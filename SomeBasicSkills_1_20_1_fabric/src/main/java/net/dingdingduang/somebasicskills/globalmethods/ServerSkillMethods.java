...
public class ServerSkillMethods {
    ...
    public static void initializePlayerPassiveStatusWhenLogin(ServerPlayerEntity sp1) {
...
//                    printInGameMsg("test: "+i++);
    ...
    public static int querySPlayerCurrentSkillLevel(ServerPlayerEntity sp1, String querySkillID) {
        Integer skillLevel;
