...
public class AttributeHelper {
    private EntityAttribute AttrType;
//    private String AttrID;
    ...
    public AttributeHelper(EntityAttribute attributeType) {
...
//    }
    ...
    public EntityAttribute getAttrType() { return AttrType; }
    public void setAttrType(EntityAttribute attrType) { AttrType = attrType; }
