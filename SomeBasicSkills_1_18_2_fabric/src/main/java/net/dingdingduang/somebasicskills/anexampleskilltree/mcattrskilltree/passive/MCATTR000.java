...
public class MCATTR000 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_DMG_0_0);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.MC_ATTR_ATTACK_DMG_0_0)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_DMG_0_0);
        ...
        PermAttributesDistributor.applyPermAttackDMGToEntity(entity1, amount, Constants.OP_ADDITION, MCAttributeSkillInitialization.MC_ATTR_ATTACK_DMG_0_0, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.MC_ATTR_ATTACK_DMG_0_0);
        tempSkillData.setTranslatableTooltipGetter(MCATTR000::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(MCATTR000::passiveAction);
        tempSkillData.setPressAddBtnAction(MCATTR000::passiveAction);
        tempSkillData.setPressSubBtnAction(MCATTR000::passiveAction);
    }
}
