...
public class EXMCATTR001 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_ATTACK_KNOCKBACK_MULTIPLIER_0_1);
        ...
        if (entity1 instanceof ServerPlayerEntity sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_ATTACK_KNOCKBACK_MULTIPLIER_0_1)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_ATTACK_KNOCKBACK_MULTIPLIER_0_1);
        ...
        PermAttributesDistributor.applyPermAttackKnockbackToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_ATTACK_KNOCKBACK_MULTIPLIER_0_1, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_ATTACK_KNOCKBACK_MULTIPLIER_0_1);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR001::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR001::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR001::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR001::passiveAction);
    }
}
