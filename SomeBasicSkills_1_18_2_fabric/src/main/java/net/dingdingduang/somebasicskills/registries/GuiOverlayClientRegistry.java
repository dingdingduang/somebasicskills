...
public class GuiOverlayClientRegistry {
    ...
    private static void registerFabricClientOverlaysFinal(MatrixStack pPoseStack, float tickDelta) {
...
//        float partialTick = tickDelta;
        ...
        CooldownOverlay.render(gameWorldTick, pPoseStack, tickDelta, screenWidth, screenHeight);
