...
public class GuiOverlayClientRegistry {
    ...
    public static void onRegisterOverlays(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_BAR, SKILLS_IN_COOLDOWN_CLIENT_TIMMER_OVERLAY_000, getSkillsInCooldownClientTimerOverlayInstance());
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_BAR, SKILL_CHANNELING_OVERLAY_001, getSkillChannelingOverlayInstance());
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_BAR, PLAYER_KEYBOARD_LISTENER_OVERLAY_002, getPlayerKerboardOverlayTimerInstance());
    }
}
