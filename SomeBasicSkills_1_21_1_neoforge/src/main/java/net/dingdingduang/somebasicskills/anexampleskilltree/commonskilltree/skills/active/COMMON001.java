...
//            getCPlayerState().put(Constants.IS_BACKSTEPPING, Constants.ACTION_ON);
        ...
        MethodAction tempSkillAction =
                (entity1) -> {
                    ...
                    applyTimedBeneficialStatusInvincibilityToEntity(entity1, duration, skill1.getDuration().get(playerSkillLVL - 1) * 10, Constants.OP_ADDITION, false, CommonSkillInitialization.COMMON_001_BACKSTEP, null, null);
                    ...
                    PlaySBSLeapSoundAtLocation(entity1.level(), entity1.getX(), entity1.getY(), entity1.getZ(), 0.5f, 1.0f);
