...
//        drawContext.fillGradient(left + 9, top + 17, left + maxWidth - 7, top + maxHeight - 19, -1000, -0x00FFEFF0, -0x00FFEFF0);
        RenderSystem.disableBlend();
        GuiMethods.drawImageOnly(pPoseStack, IconBasicResourceLocation.SKILL_INFO_SCREEN_UPPER_BACKGROUND, left + 9, top + 17, maxWidth - 16, maxHeight - 36);
