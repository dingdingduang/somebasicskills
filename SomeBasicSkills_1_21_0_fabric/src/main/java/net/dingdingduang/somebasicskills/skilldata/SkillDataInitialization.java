...
public class SkillDataInitialization {
    ...
    private static HashMap<String, HashMap<String, Identifier>> Role2IconLocMap;
    ...
    public static void SkillDataInit() {
        ...
        Role2IconLocMap = new HashMap<String, HashMap<String, Identifier>>();
    ...
    public static HashMap<String, HashMap<String, Identifier>> getRole2IconLocMap() { return Role2IconLocMap; }
    public static void setRole2IconLocMap(HashMap<String, HashMap<String, Identifier>> role2IconLocMap) { Role2IconLocMap = role2IconLocMap; }
