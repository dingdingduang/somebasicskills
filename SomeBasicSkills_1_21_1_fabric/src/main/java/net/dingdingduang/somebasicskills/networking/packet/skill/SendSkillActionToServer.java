...
public record SendSkillActionToServer(String SkillID, float ClientUserSkillIDDefaultSkillCDTime) implements CustomPayload {
    public static final CustomPayload.Id<SendSkillActionToServer> TYPE = new CustomPayload.Id<>(getMCResourceLocation(Constants.MOD_ID, "send_skill_action_to_server") );

    public static final PacketCodec<RegistryByteBuf, SendSkillActionToServer> STREAM_CODEC = PacketCodec.tuple(
            PacketCodecs.STRING,
    ...
    public static void handle(final SendSkillActionToServer data, final ServerPlayNetworking.Context context) {
