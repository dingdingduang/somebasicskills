...
public class GuiMethods {
    public static BufferAllocator getCutBuffer() { return new BufferAllocator(786432); }
    public static BufferBuilder getBufferBuilder(VertexFormat.DrawMode drawMode, VertexFormat format) { return new BufferBuilder(getCutBuffer(), drawMode, format); }
