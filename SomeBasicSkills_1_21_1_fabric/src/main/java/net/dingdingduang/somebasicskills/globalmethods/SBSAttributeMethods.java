...
public class SBSAttributeMethods {
    ...
    public static double getTimedAttributeValueFromLivingEntity(LivingEntity entity, RegistryEntry<EntityAttribute> sbsAttribute, int operation) {
        ...
        if (entityStatusMap != null) {
            String attrNameWithOpPostfix = sbsAttribute.getIdAsString() + operation;
    ...
    public static double getPermAttributeValueFromLivingEntity(LivingEntity entity, RegistryEntry<EntityAttribute> sbsAttribute, int operation) {
