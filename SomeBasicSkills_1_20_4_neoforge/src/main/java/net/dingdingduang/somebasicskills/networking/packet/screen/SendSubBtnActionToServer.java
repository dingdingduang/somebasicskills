...
public record SendSubBtnActionToServer(String SkillID) implements CustomPacketPayload {
    public static final ResourceLocation SEND_SUB_BTN_ACTION_TO_SERVER = getMCResourceLocation(Constants.MOD_ID, "send_sub_btn_action_to_server");
    ...
    public ResourceLocation id() {
        return SEND_SUB_BTN_ACTION_TO_SERVER;
    }

    public static void handle(final SendSubBtnActionToServer data, final PlayPayloadContext context) {
