...
public record FetchSetSkillCooldownFromServer(boolean IsTimerOn, String SkillID, double CooldownAmount) implements CustomPacketPayload {
    public static final ResourceLocation FETCH_SET_SKILL_COOLDOWN_FROM_SERVER = getMCResourceLocation(Constants.MOD_ID, "fetch_set_skill_cooldown_from_server");
    ...
    public ResourceLocation id() {
        return FETCH_SET_SKILL_COOLDOWN_FROM_SERVER;
    }

    public static void handle(final FetchSetSkillCooldownFromServer data, final PlayPayloadContext context) {
