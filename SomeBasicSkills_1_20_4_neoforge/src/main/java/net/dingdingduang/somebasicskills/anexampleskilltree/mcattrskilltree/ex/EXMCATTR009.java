...
public class EXMCATTR009 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_LUCK_MULTIPLIER_0_9);
        ...
        if (entity1 instanceof ServerPlayer sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_LUCK_MULTIPLIER_0_9)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_LUCK_MULTIPLIER_0_9);
        ...
        PermAttributesDistributor.applyPermLuckToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_LUCK_MULTIPLIER_0_9, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_LUCK_MULTIPLIER_0_9);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR009::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR009::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR009::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR009::passiveAction);
    }
}
