...
public class PlayerKeyComboListenerOverlayTimer implements IIngameOverlay {
...
//    private int keyboardTotalTick = 30;
    ...
    @Override
    public void render(ForgeIngameGui forgeGui, PoseStack poseStack, float partialTick, int screenWidth, int screenHeight) {
        if (this.StartTimer) {
