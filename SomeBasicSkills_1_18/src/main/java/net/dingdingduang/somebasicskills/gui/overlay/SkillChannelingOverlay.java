...
public class SkillChannelingOverlay implements IIngameOverlay {
...
//    }
    ...
    public void drawRectImage(PoseStack pPoseStack, int x, int y, int imgWidth, int imdHeight, int translateZ, ResourceLocation res1) {
        pPoseStack.pushPose();
        pPoseStack.translate(0, 0, translateZ);
        RenderSystem.setShaderColor(0.5f, 0.5f, 0.5f, 0.8f);
        GuiMethods.drawImageOnly(pPoseStack, res1, x, y, imgWidth, imdHeight, imgWidth, imdHeight, imgWidth, imdHeight);
...
//    }
    ...
    public void drawCenterString(PoseStack pPoseStack, int x1, int y1, int translateZ, String text, int pColor) {
        pPoseStack.pushPose();
        pPoseStack.translate(0, 0, translateZ);
    ...
    public void renderChannelingBar(PoseStack pPoseStack, float partialTicks, int screenWidth, int screenHeight, int skillTickElapsed, double skillMaxChannelingTime) {
        //if on same time
...
//            drawCenterString(guiGraphics, centerX, centerY, 193, (Math.round((1.0*skillTickElapsed / 20 * 10) * 1.0 / 10))+"%", 0xFFFFFF);
    ...
    @Override
    public void render(ForgeIngameGui forgeGui, PoseStack pPoseStack, float partialTick, int screenWidth, int screenHeight) {
