...
//        this.IncrementTextLengthVal = (int) (this.MaxTextLength * 0.1666667f);
    ...
    public void renderAllSettingBtns(PoseStack pPoseStack) {
        // Make sure we use a higher z-index.
        pPoseStack.pushPose();
        pPoseStack.translate(0, 0, 211);
    ...
    public void renderAllSettingBtnsDescription(PoseStack pPoseStack) {
        pPoseStack.pushPose();
        pPoseStack.translate(0, 0, 212);
        ...
        for (String configName : tempBtn2Setting.keySet()) {
            ...
            if (tempSeparatedStrArrList.size() > 1) {
                ...
                for (String tempSeparatedStr : tempSeparatedStrArrList) {
                    ...
                    GuiMethods.drawString(pPoseStack, this.font, tempStrBuilder1.toString(), 32, currentUpdatedBtnPos + 4 + 8 * extraYCounter, 0xFFFFFF);
                ...
                if (configHelper.isBooleanConfig()) {
                    ...
                    GuiMethods.drawString(pPoseStack, this.font, tempStrBuilder1.toString(), this.IncrementTextLengthVal * 6 + 38, currentUpdatedBtnPos + 4 + 4 * extraYCounter, 0xFFFFFF);
                }
                else {
...
//                    GuiMethods.drawString();(pPoseStack, this.font, tempStrBuilder1.toString(), 32, this.ConfigName2SettingBtn.get(configName).getY() + 4, 0xFFFFFF);
            }
            else {
                tempStrBuilder1 = new StringBuilder();
                tempStrBuilder1.append(tempSeparatedStrArrList.get(0));
                ...
                GuiMethods.drawString(pPoseStack, this.font, tempStrBuilder1.toString(), 32, tempImgBtn.getButtonOriginalPosY() + 4, 0xFFFFFF);
                tempImgBtn.setButtonOriginalPosY( currentUpdatedBtnPos );
                tempImgBtn.setSBSBtnPosY(tempImgBtn.getButtonOriginalPosY());
            }
        }
