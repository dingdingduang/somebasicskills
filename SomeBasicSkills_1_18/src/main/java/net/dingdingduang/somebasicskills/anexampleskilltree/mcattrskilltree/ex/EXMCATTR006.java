...
public class EXMCATTR006 {
    ...
    public static void passiveAction(LivingEntity entity1) {
        ...
        SkillDataJson skill1 = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_MAX_HEALTH_MULTIPLIER_0_6);
        ...
        if (entity1 instanceof ServerPlayer sp1) {
            ...
            if (getGlobalPlayerSkillID2lvlMap().get(sp1).containsKey(MCAttributeSkillInitialization.EXMC_ATTR_MAX_HEALTH_MULTIPLIER_0_6)) {
                playerSkillLVL = getGlobalPlayerSkillID2lvlMap().get(sp1).get(MCAttributeSkillInitialization.EXMC_ATTR_MAX_HEALTH_MULTIPLIER_0_6);
        ...
        PermAttributesDistributor.applyPermMaxHealthToEntity(entity1, amount, Constants.OP_MULTIPLY_BASE, MCAttributeSkillInitialization.EXMC_ATTR_MAX_HEALTH_MULTIPLIER_0_6, null);
    }

    public static void init() {
        SkillDataJson tempSkillData = getID2SkillData().get(MCAttributeSkillInitialization.EXMC_ATTR_MAX_HEALTH_MULTIPLIER_0_6);
        tempSkillData.setTranslatableTooltipGetter(EXMCATTR006::getSkillDescription);

        tempSkillData.setPassiveStatusWhenLoginAction(EXMCATTR006::passiveAction);
        tempSkillData.setPressAddBtnAction(EXMCATTR006::passiveAction);
        tempSkillData.setPressSubBtnAction(EXMCATTR006::passiveAction);
    }
}
