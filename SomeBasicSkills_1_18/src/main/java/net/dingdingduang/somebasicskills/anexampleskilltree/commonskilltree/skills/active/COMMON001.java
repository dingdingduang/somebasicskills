...
//            getCPlayerState().put(Constants.IS_BACKSTEPPING, Constants.ACTION_ON);
        ...
        MethodAction tempSkillAction =
                (entity1) -> {
                    ...
                    PlaySoundAtLocation(COMMON_0_1_LEAP_SOUND.get(), entity1.getLevel(), entity1.getX(), entity1.getY(), entity1.getZ(), 0.5f, 1.0f);
                    ...
                    MethodAction action =
                            (entity2) ->  {
                                ...
                                if (distHasTraveled < finalDist || updatedTick > 60) {
                                    ...
                                    BlockState state = entity2.getLevel().getBlockState(new BlockPos(x, y, z));
